...
public class MyCar {
    public static void main(String[] args) {
        ...
        if(carinfo.getCarBrand().equals("현대")){
            ...
            System.out.println("이 차의 종류는 분류되지 않았습니다.");
        }




        System.out.println("이 차는 "+carinfo.getCarYear()+" 년식 "+carinfo.getCarBrand()+" "+carinfo.getCarName()+" "+ "이며"+" 색상은 "+carinfo.getCarColor()+" "+"입니다.");
